% === T04 - Introducción a los Sistemas Operativos ===
...
\begin{frame}{Clasificaciones de Sistemas Operativos}
    ...
    \begin{itemize}
    \item[-] \small Monotarea: \textcolor{verdeuca}{Ejecuta solo una tarea a la vez. Puede ejecutar más de una tarea de forma cooperativa.}
...
\begin{frame}{Llamadas al Sistema Operativo}
    ...
    \begin{center}
    \uncover<2->{\includegraphics[scale=0.65]{img/library.pdf}}
    \end{center}
    \end{textblock}
\end{frame}
